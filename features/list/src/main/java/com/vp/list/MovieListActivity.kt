...
class MovieListActivity : AppCompatActivity(), HasAndroidInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            searchInput = savedInstanceState.getString(IS_SEARCH_VIEW_TEXT, "")
        }
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString(IS_SEARCH_VIEW_TEXT, searchView.query.toString())
    }
    ...
    companion object {
        ...
        private const val IS_SEARCH_VIEW_TEXT = "is_search_view_text"
    }
}